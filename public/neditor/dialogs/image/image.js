 ...
 */
  ...
  // 计算签名
let getAuthorization = (options, credentials) => {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (object, data, headers) {
                ...
                let headerAuth = {
                  ...
                  'x-cos-security-token': 'res.XCosSecurityToken'
                }
                headers = Object.assign(headerAuth, headers);
                editor.getOpt("imageUploadService")(_this, editor).setFormData(object, data, headers);
                console.log(editor.getOpt("imageUploadService")(_this, editor));
                // zheng
                ...
                //   getAuthorization(options, token.credentials).then(res => {
                //     let headerAuth = {
                //       Authorization: res.Authorization,
                //       'x-cos-security-token': res.XCosSecurityToken
                //     }
            ...
            $upload.on('click', function () {
                ...
                if (state === 'ready') {
                    window.setTimeout(function() {
                        // uploader.options.server = uploader.options.server + '/favicon.png';
